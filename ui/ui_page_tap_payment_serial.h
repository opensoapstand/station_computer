/********************************************************************************
** Form generated from reading UI file 'page_tap_payment_serial.ui'
**
...
#ifndef UI_PAGE_TAP_PAYMENT_SERIAL_H
#define UI_PAGE_TAP_PAYMENT_SERIAL_H
...
class Ui_page_tap_payment_serial
{
public:
    ...
    void setupUi(QWidget *page_tap_payment_serial)
    {
        if (page_tap_payment_serial->objectName().isEmpty())
            page_tap_payment_serial->setObjectName(QStringLiteral("page_tap_payment_serial"));
        page_tap_payment_serial->resize(1080, 1920);
        page_tap_payment_serial->setStyleSheet(QStringLiteral(""));
        pushButton_previous_page = new QPushButton(page_tap_payment_serial);
        ...
        pushButton_to_idle = new QPushButton(page_tap_payment_serial);
        ...
        order_total_amount = new QLabel(page_tap_payment_serial);
...
"color: #58595B;"));
        ...
        order_drink_amount = new QLabel(page_tap_payment_serial);
...
"color: #58595B;"));
        ...
        pushButton_payment_bypass = new QPushButton(page_tap_payment_serial);
        ...
        productLabel = new QLabel(page_tap_payment_serial);
...
"color: #58595B;"));
        ...
        retranslateUi(page_tap_payment_serial);

        QMetaObject::connectSlotsByName(page_tap_payment_serial);
    } // setupUi

    void retranslateUi(QWidget *page_tap_payment_serial)
    {
        page_tap_payment_serial->setWindowTitle(QApplication::translate("page_tap_payment_serial", "Form", Q_NULLPTR));
        pushButton_previous_page->setText(QApplication::translate("page_tap_payment_serial", "back", Q_NULLPTR));
        pushButton_to_idle->setText(QString());
        order_total_amount->setText(QString());
        order_drink_amount->setText(QApplication::translate("page_tap_payment_serial", "order_drink_amount", Q_NULLPTR));
        pushButton_payment_bypass->setText(QString());
        productLabel->setText(QApplication::translate("page_tap_payment_serial", "order summary", Q_NULLPTR));
        label_title->setText(QApplication::translate("page_tap_payment_serial", "title", Q_NULLPTR));
...
namespace Ui {
    class page_tap_payment_serial: public Ui_page_tap_payment_serial {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_PAGE_TAP_PAYMENT_SERIAL_H
