...
signals:
    ...
    void finalTransactionMessageSignal(QString status, QString start_time, QString end_time, double button_press_duration, double button_press_count, double volume_dispensed,double volume_remaining, QString volumeDispensedMixProduct);
