...
configurationDatabase = sqlite3.connect("/home/df-admin/production/db/configuration")
usageDatabase = sqlite3.connect("/home/df-admin/production/db/configuration")
...
for product in products:
   ...
   try:
        productUpdate = usageDatabase.execute("Update products set price_small=?, price_medium=?, price_large=?, price_custom=?, size_small=?, size_medium=?, size_large=?, soapstand_product_serial=? where productId=?",\
        ...
        logging.error("usageDatabase values are not matching the data type");
logging.info("-------------------------------------------------------------------------------------------------------")
