...
//
// transactionPacket.h
// moneris payment device packet to send
//
// created: 03-Oct-2019
// by: Jason
//
...
std::vector<uint8_t> transactionPacket::purchaseCancelPacket()
{
    ...
    //parentID is fixed 0x02                                    //02
    packet.setPacketClassID(communicationPacketField::ppPos);   //0D
    packet.setPacketApiID(API_ID::PpPosCancel);                 //00 01
...
std::vector<uint8_t> transactionPacket::ppPosGetConfigPkt()
{
    uint8_t dataPacket[] = {}; //tag id for infomation requested
                                            //enum TxnTyp
    //STX is 0x02                                               //02
    //parentID is fixed 0x02                                    //02
    packet.setPacketClassID(communicationPacketField::ppPos);   //0D
