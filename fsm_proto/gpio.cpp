...
void gpio::activateGPIO(int gpio){
...
void gpio::setGPIO_input(int gpio){
...
void gpio::setGPIO_output(int gpio){
...
void gpio::setGPIO_high(int gpio){
...
void gpio::setGPIO_low(int gpio){
...
void gpio::setGPIO_edge_both(int gpio){
...
void gpio::setGPIO_edge_rising(int gpio){
...
void gpio::setGPIO_edge_falling(int gpio){
