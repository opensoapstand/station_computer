...
public:
    ...
    std::vector<std::tuple<QString, QString, QString>> productsTableLayout = {
                        ...
                        {"int", "soapstand_product_serial","2"},
                        ...
                        {"int",  "is_enabled_small","1"},
                        {"int",  "is_enabled_medium","0"},
                        {"int",  "is_enabled_large","1"},
                        {"int",  "is_enabled_custom","0"},
    ...
    std::vector<std::tuple<QString, QString, QString>> machineTableLayout = {
                        ...
                        {"QString",  "screen_id",""},
                        {"int",  "has_receipt_printer","0"},
                        {"int",  "receipt_printer_is_online","0"},
                        {"int",  "receipt_printer_has_paper","0"},
                        {"int",  "has_tap_payment","0"},
                        {"QString",  "hardware_version",""},
                        {"QString",  "software_version",""},
                        {"int",  "aws_port",""},
                        {"int",  "coupons_enabled","0"},
                        {"int",  "has_empty_detection","0"},
