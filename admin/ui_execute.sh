...
source enableIPForward.sh  # create a connection between the two LAN controllers with a static ip on the Odyssey. This way, one network can access the internet to which the other network is connected. Used for tap payment
