...
// by: <Gabriel Leung>
//
// copyright 202s0 by Drinkfill Beverages Ltd
// all rights reserved
//***************************************
...
void dispense::dispenseHIGH(int sensor, int drink, int water, int air){

  gpio gpio;
  interrupt interrupt;
  i2c i2c;

  int sensorGPIO[] = { 275,280,273,278,276,279,307,358,243 };
...
void dispense::dispenseLOW(int sensor, int drink, int water, int air){
